...
import numpy as np
from utility import cal_2hop, get_all_neighbors, decode_input, convert_to_binary, sigmoid


  
def fitness_bin(inp, args):    
    seed = decode_input(inp, args)
    return fitness(inp, args, seed)
    

def fitness_con(inp, args):    
    return fitness(inp, args, inp)


def fitness(inp, args, seed): 
